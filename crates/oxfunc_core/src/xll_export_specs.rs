...
use crate::functions::{
    ...
    call_register_id_family::{CALL_META, REGISTER_ID_META},
    callable_helpers::{
    ...
    dynamic_array_reshape_family::{
        CHOOSECOLS_META, CHOOSEROWS_META, DROP_META, EXPAND_META, FILTER_META, SORT_META,
        SORTBY_META, TAKE_META, TOCOL_META, TOROW_META, TRANSPOSE_META, UNIQUE_META, VSTACK_META,
        WRAPCOLS_META, WRAPROWS_META,
    },
    ...
    offset::OFFSET_META,
    op_add::OP_ADD_META,
    op_spill_ref::OP_SPILL_REF_META,
    operator_arithmetic_family::{
        OP_DIVIDE_META, OP_MULTIPLY_META, OP_NEGATE_META, OP_PERCENT_META, OP_POWER_META,
        OP_SUBTRACT_META, OP_UNARY_PLUS_META,
    },
    operator_compare_concat_family::{
        OP_CONCAT_META, OP_EQUAL_META, OP_GREATER_EQUAL_META, OP_GREATER_THAN_META,
        OP_LESS_EQUAL_META, OP_LESS_THAN_META, OP_NOT_EQUAL_META,
    },
    operator_reference_family::{
        OP_INTERSECTION_REF_META, OP_RANGE_REF_META, OP_TRIM_REF_BOTH_META,
        OP_TRIM_REF_LEADING_META, OP_TRIM_REF_TRAILING_META, OP_UNION_REF_META,
    },
    or_fn::OR_META,
    ...
    rank_fn::RANK_META,
    reference_metadata_family::{
        ADDRESS_META, AREAS_META, FORMULATEXT_META, SHEET_META, SHEETS_META,
    },
    ...
    subtotal_aggregate_family::{AGGREGATE_META, SUBTOTAL_META},
    sum::SUM_META,
    sumproduct_family::{
    ...
    web_text_xml_family::{ENCODEURL_META, FILTERXML_META},
...
const FUNCTION_CATALOG: &[FunctionMeta] = &[
    ...
    OP_DIVIDE_META,
    OP_EQUAL_META,
    OP_GREATER_EQUAL_META,
    OP_GREATER_THAN_META,
    OP_INTERSECTION_REF_META,
    OP_LESS_EQUAL_META,
    OP_LESS_THAN_META,
    OP_MULTIPLY_META,
    OP_NEGATE_META,
    ...
    OP_SPILL_REF_META,
    OP_SUBTRACT_META,
    OP_TRIM_REF_BOTH_META,
    OP_TRIM_REF_LEADING_META,
    OP_TRIM_REF_TRAILING_META,
    OP_UNARY_PLUS_META,
    OP_UNION_REF_META,
    PERMUT_META,
    PERMUTATIONA_META,
