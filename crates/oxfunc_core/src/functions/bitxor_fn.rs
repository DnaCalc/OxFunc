...
pub const BITXOR_META: FunctionMeta = function_spec! {
...
pub fn bitxor_kernel(lhs: f64, rhs: f64) -> Result<f64, WorksheetErrorCode> {
...
pub fn map_bitxor_error_to_ws(e: &BinaryNumericSurfaceError) -> WorksheetErrorCode {
