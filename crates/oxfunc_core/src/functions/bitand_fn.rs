...
pub const BITAND_META: FunctionMeta = function_spec! {
...
pub fn bitand_kernel(lhs: f64, rhs: f64) -> Result<f64, WorksheetErrorCode> {
...
pub fn map_bitand_error_to_ws(e: &BinaryNumericSurfaceError) -> WorksheetErrorCode {
