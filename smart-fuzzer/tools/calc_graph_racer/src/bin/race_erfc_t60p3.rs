//! 0x4e05 Horner + P/Q 3-coeff ±1 DIRECT z>=4. Not an identity.
...
fn main() {
    ...
    println!("top 12 P/Q 3-coeff ±1 on 0x4e05:");
    ...
    println!(
        "3-coeff on 0x4e05 n={} beat60={nbeat} best={} ge62={nge62} gt62={ngt62}",
        best.len(),
        best[0].0
    );
}
