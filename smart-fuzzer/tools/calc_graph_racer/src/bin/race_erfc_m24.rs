//! Mixed best_direct_tail cephes mask 0x24a5 as Q-tail vs 0x5005. Not an identity.
...
fn main() {
    ...
    println!("Cephes masks as Q-tail (bars 0x5005 1572 / mixed direct 0x24a5):");
    for &mask in &[0u32, 0x5005, 0x24a5, 0x74, 0x200, 0x210] {
        let mut ex = 0usize;
        let mut dd = 0usize;
        let mut n = 0usize;
        let mut mx = 0u64;
