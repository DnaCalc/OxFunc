//! Exhaustive 8-bit Cephes Horner stores DIRECT z>=4. Not an identity.
...
fn main() {
    ...
    println!("DIRECT z>=4 n={n} unmask={} 0x4e05={}", score(0), score(0x4e05));
    ...
    println!(
        "best 8-bit={best} mask={:#x} unique={} nbest={nbest} ge60={nge60} gt60={ngt60} n8={}",
        ranked[0].1,
        nbest == 1,
        ranked.len()
    );
