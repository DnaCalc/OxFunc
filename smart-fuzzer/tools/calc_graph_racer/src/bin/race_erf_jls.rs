//! joint-866 vs last-store z±1±2 ∪ ow±1±2. Not an identity.
...
fn main() {
    ...
    println!(
        "joint vs last-store z±1±2∪ow±1±2 both={both} only_joint={only_j} only_ls={only_l} union={}/{} leftover-LOW {hit_low}/{n_low} leftover-HIGH {hit_high}/{n_high}",
        both + only_j + only_l,
        rows.len()
    );
}
