//! 0x210+C[3]-1 C[4]+1 C[5]-1 C[6]+1 vs unmask 107. Not an identity.
...
fn main() {
    ...
    let mut nb = 0usize;
    let mut n210 = 0usize;
    println!("DIRECT [0.5,4) n={n} 114 vs unmask 107:");
    for r in &dirs {
        let t = f64::from_bits(r.qbits);
        let ea = hit(r.z, t, &c114, &D0, 0x210);
    ...
    println!(
        "114={na} 107={nb} 0x210={n210} both={both} only_114={only_a} only_107={only_b} union={}",
        both + only_a + only_b
    );
}
