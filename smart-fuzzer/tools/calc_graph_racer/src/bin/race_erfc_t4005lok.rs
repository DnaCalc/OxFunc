//! leftover-low last-store k of unmask 0x4005 vs 0x4e05. Not an identity.
...
fn main() {
    ...
    println!("leftover-low last-store k of unmask 0x4005 vs 0x4e05:");
    ...
    print!("0x4005 leftover-low n={n4} unmask |k|");
    for (i, c) in h4.iter().enumerate() {
        if *c > 0 {
            print!(" {i}:{c}");
        }
    }
    print!("\n0x4e05 leftover-low n={n4e} unmask |k|");
