//! Leftover-low 13 joint-hard vs fdlibm PP / Cephes T/U / A/B. Not an identity.
...
fn main() {
    ...
    for (name, ev) in graphs {
        ...
        println!("{name:22} hard_hit={hit}/{} ulp1={u1} keep={keep}/1508", lows.len());
    }
}
