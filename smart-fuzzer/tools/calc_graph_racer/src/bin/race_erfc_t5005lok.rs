//! leftover-low last-store k of unmask 0x5005 vs 66. Not an identity.
...
fn main() {
    ...
    println!("leftover-low last-store k of unmask 0x5005 vs 66:");
    ...
    print!("0x5005 leftover-low n={n5} unmask |k|");
    for (i, c) in h5.iter().enumerate() {
        if *c > 0 {
            print!(" {i}:{c}");
        }
    }
    print!("\n66 leftover-low n={n66} unmask |k|");
