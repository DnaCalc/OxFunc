//! 0x4e05 leftover ± and 1-ULP vs unmask cephes F last-store. Not an identity.
...
fn main() {
    ...
    println!("0x4e05 leftover ± and 1-ULP vs unmask F DIRECT z>=4 n={n}:");
    for r in &tail {
    ...
    println!();
    println!(
        "0x4e05 envelope vs unmask last-store cover={}",
