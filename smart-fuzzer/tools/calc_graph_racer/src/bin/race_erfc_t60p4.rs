//! 0x4e05 Horner + P/Q 4-coeff ±1 DIRECT z>=4. Not an identity.
...
fn main() {
    ...
    println!("0x4e05 fused DIRECT z>=4={base}/{ntail}");
    let mut best_s = base;
    ...
    println!("top 12 P/Q 4-coeff ±1 on 0x4e05 (fused>=65):");
    ...
    println!(
        "4-coeff on 0x4e05 n={ncfg} beat60={nbeat} best={best_s} {}{:+} {}{:+} {}{:+} {}{:+} ge65={nge65} gt65={ngt65}",
        name_pq(best_t.0),
        best_t.1,
        name_pq(best_t.2),
        best_t.3,
