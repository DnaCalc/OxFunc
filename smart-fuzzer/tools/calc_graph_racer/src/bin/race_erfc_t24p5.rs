//! 0x24a5 Horner + P/Q 5-coeff ±1 DIRECT z>=4. Not an identity.
...
fn main() {
    ...
    let mut ngt66 = 0usize;
    let mut nge66 = 0usize;
    let mut ncfg = 0usize;
    ...
    println!(
        "5-coeff on 0x24a5 n={ncfg} beat60={nbeat} best={best_s} {}{:+} {}{:+} {}{:+} {}{:+} {}{:+} ge66={nge66} gt66={ngt66}",
        name_pq(best_t.0),
        best_t.1,
        name_pq(best_t.2),
        best_t.3,
