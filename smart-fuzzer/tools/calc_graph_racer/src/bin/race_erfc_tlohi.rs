//! Tail leftover-high of 0x5005 as 66 and 0x4005 as 0x4e05. Not an identity.
...
fn main() {
    ...
    let mut n = 0usize;
    let mut b = [0usize; 4];
    println!("0x5005 leftover-high as 66:");
    for r in &tail {
        ...
        n += 1;
        let bb = bucket(mul(f::w_rn53(r.z), cephes(r.z, &p66, &q66, 0x24a5)), t);
        b[idx(bb)] += 1;
        if bb != "leftover-high" {
            println!("  z={:.16} d5005={d5} 66={bb}", r.z);
        }
    }
    print!("0x5005 leftover-high n={n} as 66");
    ...
    let mut n4 = 0usize;
    let mut b4 = [0usize; 4];
    println!("0x4005 leftover-high as 0x4e05:");
    for r in &tail {
        let t = f64::from_bits(r.qbits);
        ...
        n4 += 1;
        let bb = bucket(mul(f::w_rn53(r.z), cephes(r.z, &P0, &Q0, 0x4e05)), t);
        b4[idx(bb)] += 1;
        if bb != "leftover-high" {
            println!("  z={:.16} d4005={d4} 0x4e05={bb}", r.z);
        }
    }
    print!("0x4005 leftover-high n={n4} as 0x4e05");
    ...
    println!("0x4e05 leftover-high as 0x4005:");
    for r in &tail {
        let t = f64::from_bits(r.qbits);
        ...
        n4e += 1;
        let bb = bucket(mul(f::w_rn53(r.z), cephes(r.z, &P0, &Q0, 0x4005)), t);
        b4e[idx(bb)] += 1;
        if bb != "leftover-high" {
            println!("  z={:.16} d4e05={d} 0x4005={bb}", r.z);
        }
    }
    print!("0x4e05 leftover-high n={n4e} as 0x4005");
