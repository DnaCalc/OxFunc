    ...
    let variants: Vec<(&str, Box<dyn Fn(f64) -> f64>)> = vec![
        ...
        (
            ...
            Box::new(|t: f64| {
                ...
                if t.abs() < 1.0 {
                    let p = e((u - 1.0) * t);
                    tfr(&rx::ext_div(&p, &e(rx::excel_ln(u)), CW), CW_RZ)
                } else {
                    u - 1.0
                }
            }),
