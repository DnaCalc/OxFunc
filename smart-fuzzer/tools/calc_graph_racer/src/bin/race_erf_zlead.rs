//! 4 LOW: joint lead z±k ulp, original w/t. Not an identity.
...
fn main() {
    ...
    let graphs: [(&str, Box<dyn Fn(f64) -> f64>); 6] = [
        ...
        ("lead+1", Box::new(|z| joint_t(z.next_up(), z))),
        (
            "lead+2",
            Box::new(|z| joint_t(z.next_up().next_up(), z)),
        ),
        (
            "lead+3",
            Box::new(|z| joint_t(z.next_up().next_up().next_up(), z)),
        ),
        ("lead-1", Box::new(|z| joint_t(z.next_down(), z))),
        (
            "both+2",
            Box::new(|z| {
    ...
    println!("4 LOW joint lead z±k original t:");
    for &lz in &LOWS {
