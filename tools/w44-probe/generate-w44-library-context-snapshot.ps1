...
function Get-InterfaceContractRef {
    ...
    switch ($StableId) {
        "FUNC.OP_ADD" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_ARITHMETIC_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_DIVIDE" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_ARITHMETIC_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_MULTIPLY" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_ARITHMETIC_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_NEGATE" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_ARITHMETIC_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_PERCENT" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_ARITHMETIC_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_POWER" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_ARITHMETIC_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_SUBTRACT" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_ARITHMETIC_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_UNARY_PLUS" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_ARITHMETIC_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_CONCAT" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_COMPARE_CONCAT_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_EQUAL" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_COMPARE_CONCAT_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_GREATER_EQUAL" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_COMPARE_CONCAT_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_GREATER_THAN" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_COMPARE_CONCAT_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_LESS_EQUAL" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_COMPARE_CONCAT_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_LESS_THAN" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_COMPARE_CONCAT_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_NOT_EQUAL" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_COMPARE_CONCAT_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_INTERSECTION_REF" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_REFERENCE_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_RANGE_REF" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_REFERENCE_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_TRIM_REF_BOTH" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_REFERENCE_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_TRIM_REF_LEADING" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_REFERENCE_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_TRIM_REF_TRAILING" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_REFERENCE_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_UNION_REF" { return "docs/function-lane/FUNCTION_SLICE_OPERATOR_REFERENCE_FAMILY_CONTRACT_PRELIM.md" }
        "FUNC.OP_SPILL_REF" { return "docs/function-lane/FUNCTION_SLICE_OP_SPILL_REF_CONTRACT_PRELIM.md" }
    }
