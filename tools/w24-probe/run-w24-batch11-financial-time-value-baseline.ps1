param(
    [string]$Manifest = "docs/function-lane/W24_BATCH11_FINANCIAL_TIME_VALUE_SCENARIO_MANIFEST_SEED.csv",
    [string]$Out = ".tmp/w24-batch11-financial-time-value-results.csv"
)
