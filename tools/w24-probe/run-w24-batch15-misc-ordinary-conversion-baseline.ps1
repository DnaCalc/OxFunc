param(
    [string]$Manifest = "docs/function-lane/W24_BATCH15_MISC_ORDINARY_CONVERSION_SCENARIO_MANIFEST_SEED.csv",
    [string]$Out = ".tmp/w24-batch15-misc-ordinary-conversion-results.csv"
)
