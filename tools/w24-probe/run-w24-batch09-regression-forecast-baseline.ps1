param(
    [string]$Manifest = "docs/function-lane/W24_BATCH09_REGRESSION_FORECAST_SCENARIO_MANIFEST_SEED.csv",
    [string]$Out = ".tmp/w24-batch09-regression-forecast-results.csv"
)
