param(
    [string]$Manifest = "docs/function-lane/W24_BATCH08_LOOKUP_PROB_FREQUENCY_SCENARIO_MANIFEST_SEED.csv",
    [string]$Out = ".tmp/w24-batch08-lookup-prob-frequency-results.csv"
)
