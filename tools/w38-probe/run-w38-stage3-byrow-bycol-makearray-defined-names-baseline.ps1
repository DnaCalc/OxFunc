param(
    [string]$Manifest = "docs/function-lane/W38_STAGE3_BYROW_BYCOL_MAKEARRAY_DEFINED_NAMES_SCENARIO_MANIFEST_SEED.csv",
    [string]$Out = ".tmp/w38-stage3-byrow-bycol-makearray-defined-names-results.csv"
)
...
$wb.Names.Add("MyAdder", "=LAMBDA(x,x+1)") | Out-Null
$wb.Names.Add("CapAdd", "=LET(x,2,LAMBDA(y,x+y))") | Out-Null
