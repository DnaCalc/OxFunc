...
Last reconciled: `2026-09-12` (GAMMALN Stirling `x>=8` now uses worksheet LN plus
x87 DR on the q chain and final add: 1709/1711 unique high-band rows, live
build 20326 pin sign-off. Two 1-ULP rows remain. G3-02 stays open. ERFC Lentz
