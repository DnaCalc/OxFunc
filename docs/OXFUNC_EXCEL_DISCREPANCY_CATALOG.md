...
Last reconciled: `2026-09-12` (GAMMA half-integers `16.5..=19.5` now use native
recurrence from the closed-form `15.5` value; first miss `20.5`. GAMMALN Stirling
`x>=8` uses worksheet LN plus x87 DR: 1709/1711. G3-02 stays open. ERFC Lentz
tail 1324 is a constraint, not an identity.)
