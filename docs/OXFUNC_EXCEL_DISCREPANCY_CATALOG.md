...
Last reconciled: `2026-09-12` (GAMMA quarter-integers `n+1/4` and `n+3/4` for
`n=0..=5` use native recurrence from live seeds. Tiny-x `<=1e-16` is `1/x`.
G3-02 stays open. ERFC Lentz tail 1324 is a constraint, not an identity.)
