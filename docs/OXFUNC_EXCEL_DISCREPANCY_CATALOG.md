...
Last reconciled: `2026-09-12` (GAMMA tiny-x `<=1e-16` is `1/x`; subnormals
`#NUM!`. Half-integers `16.5..=19.5` use recurrence from `15.5`. G3-02 stays
open. ERFC Lentz tail 1324 is a constraint, not an identity.)
