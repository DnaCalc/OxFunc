...
2. `28` rows already witness-covered in the seeded V2 surface,
3. `489` rows still requiring W071 witness population.

The remaining `489` rows are partitioned exactly as the frozen tranche ledger
states:
