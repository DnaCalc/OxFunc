...
2. `31` rows already witness-covered in the seeded V2 surface,
3. `486` rows still requiring W071 witness population.

The remaining `486` rows are partitioned exactly as the frozen tranche ledger
states:
