# WORKSET - TUX1000 Kickoff Program (W1-W6)

## 1. Purpose
This document treats worksets W1-W6 as one coupled kickoff program.

Goal:
1. establish OxFunc execution method integrity,
2. close core semantic substrate (floating-point + value universe + coercion seam),
...
3. W3 -> W4
4. W2 + W3 + W4 -> W5
5. W3 + W4 (+ W2 numeric-edge feed) -> W6
...
1. function-lane conformance row alignment (`FDEF-026..FDEF-031` at minimum),
