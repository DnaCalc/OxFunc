...
3. `172` seeded witness rows,
4. a frozen remaining-surface gap inventory for `345` supported rows,
...
2. current witness-covered rows: `172`
3. current remaining supported rows needing witness population: `345`
...
1. tranche-level generation rules for the remaining 345 rows,
