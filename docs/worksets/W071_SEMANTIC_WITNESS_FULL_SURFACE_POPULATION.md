...
3. `166` seeded witness rows,
4. a frozen remaining-surface gap inventory for `351` supported rows,
...
2. current witness-covered rows: `166`
3. current remaining supported rows needing witness population: `351`
...
1. tranche-level generation rules for the remaining 351 rows,
