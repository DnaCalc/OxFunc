...
3. `127` seeded witness rows,
4. a frozen remaining-surface gap inventory for `390` supported rows,
...
2. current witness-covered rows: `127`
3. current remaining supported rows needing witness population: `390`
...
1. tranche-level generation rules for the remaining 390 rows,
