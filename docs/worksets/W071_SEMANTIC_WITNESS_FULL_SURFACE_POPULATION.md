...
3. `136` seeded witness rows,
4. a frozen remaining-surface gap inventory for `381` supported rows,
...
2. current witness-covered rows: `136`
3. current remaining supported rows needing witness population: `381`
...
1. tranche-level generation rules for the remaining 381 rows,
