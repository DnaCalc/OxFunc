...
3. `154` seeded witness rows,
4. a frozen remaining-surface gap inventory for `363` supported rows,
...
2. current witness-covered rows: `154`
3. current remaining supported rows needing witness population: `363`
...
1. tranche-level generation rules for the remaining 363 rows,
