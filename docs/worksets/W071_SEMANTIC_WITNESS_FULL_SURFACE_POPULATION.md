...
3. `220` seeded witness rows,
4. a frozen remaining-surface gap inventory for `297` supported rows,
...
2. current witness-covered rows: `220`
3. current remaining supported rows needing witness population: `297`
...
1. tranche-level generation rules for the remaining 297 rows,
