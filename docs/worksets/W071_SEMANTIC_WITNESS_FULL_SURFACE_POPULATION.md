...
3. `181` seeded witness rows,
4. a frozen remaining-surface gap inventory for `336` supported rows,
...
2. current witness-covered rows: `181`
3. current remaining supported rows needing witness population: `336`
...
1. tranche-level generation rules for the remaining 336 rows,
