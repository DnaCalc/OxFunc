...
3. `34` seeded witness rows,
4. a frozen remaining-surface gap inventory for `483` supported rows,
...
2. current witness-covered rows: `34`
3. current remaining supported rows needing witness population: `483`
...
1. tranche-level generation rules for the remaining 483 rows,
