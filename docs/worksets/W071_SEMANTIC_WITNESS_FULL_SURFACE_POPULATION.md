...
3. `196` seeded witness rows,
4. a frozen remaining-surface gap inventory for `321` supported rows,
...
2. current witness-covered rows: `196`
3. current remaining supported rows needing witness population: `321`
...
1. tranche-level generation rules for the remaining 321 rows,
