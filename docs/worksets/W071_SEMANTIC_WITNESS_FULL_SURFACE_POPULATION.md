...
3. `223` seeded witness rows,
4. a frozen remaining-surface gap inventory for `294` supported rows,
...
2. current witness-covered rows: `223`
3. current remaining supported rows needing witness population: `294`
...
1. tranche-level generation rules for the remaining 294 rows,
