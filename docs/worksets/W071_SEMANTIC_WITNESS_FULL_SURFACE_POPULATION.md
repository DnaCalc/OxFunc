...
3. `106` seeded witness rows,
4. a frozen remaining-surface gap inventory for `411` supported rows,
...
2. current witness-covered rows: `106`
3. current remaining supported rows needing witness population: `411`
