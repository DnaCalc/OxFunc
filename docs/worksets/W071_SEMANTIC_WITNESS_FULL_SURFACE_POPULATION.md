...
3. `139` seeded witness rows,
4. a frozen remaining-surface gap inventory for `378` supported rows,
...
2. current witness-covered rows: `139`
3. current remaining supported rows needing witness population: `378`
...
1. tranche-level generation rules for the remaining 378 rows,
