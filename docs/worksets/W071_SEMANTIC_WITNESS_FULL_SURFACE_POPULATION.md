...
3. `208` seeded witness rows,
4. a frozen remaining-surface gap inventory for `309` supported rows,
...
2. current witness-covered rows: `208`
3. current remaining supported rows needing witness population: `309`
...
1. tranche-level generation rules for the remaining 309 rows,
