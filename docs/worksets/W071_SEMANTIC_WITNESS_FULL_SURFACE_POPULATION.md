...
3. `250` seeded witness rows,
4. a frozen remaining-surface gap inventory for `267` supported rows,
...
2. current witness-covered rows: `250`
3. current remaining supported rows needing witness population: `267`
...
1. tranche-level generation rules for the remaining 267 rows,
