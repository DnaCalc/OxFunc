...
3. `37` seeded witness rows,
4. a frozen remaining-surface gap inventory for `480` supported rows,
...
2. current witness-covered rows: `37`
3. current remaining supported rows needing witness population: `480`
...
1. tranche-level generation rules for the remaining 480 rows,
