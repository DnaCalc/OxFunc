...
3. `55` seeded witness rows,
4. a frozen remaining-surface gap inventory for `462` supported rows,
...
2. current witness-covered rows: `55`
3. current remaining supported rows needing witness population: `462`
...
1. tranche-level generation rules for the remaining 462 rows,
