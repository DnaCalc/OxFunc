...
3. `217` seeded witness rows,
4. a frozen remaining-surface gap inventory for `300` supported rows,
...
2. current witness-covered rows: `217`
3. current remaining supported rows needing witness population: `300`
...
1. tranche-level generation rules for the remaining 300 rows,
