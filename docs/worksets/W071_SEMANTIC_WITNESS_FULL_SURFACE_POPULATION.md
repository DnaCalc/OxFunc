...
3. `163` seeded witness rows,
4. a frozen remaining-surface gap inventory for `354` supported rows,
...
2. current witness-covered rows: `163`
3. current remaining supported rows needing witness population: `354`
...
1. tranche-level generation rules for the remaining 354 rows,
