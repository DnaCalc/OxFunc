...
3. `169` seeded witness rows,
4. a frozen remaining-surface gap inventory for `348` supported rows,
...
2. current witness-covered rows: `169`
3. current remaining supported rows needing witness population: `348`
...
1. tranche-level generation rules for the remaining 348 rows,
