...
3. `94` seeded witness rows,
4. a frozen remaining-surface gap inventory for `423` supported rows,
...
2. current witness-covered rows: `94`
3. current remaining supported rows needing witness population: `423`
