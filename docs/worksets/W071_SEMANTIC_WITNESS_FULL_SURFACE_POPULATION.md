...
3. `43` seeded witness rows,
4. a frozen remaining-surface gap inventory for `474` supported rows,
...
2. current witness-covered rows: `43`
3. current remaining supported rows needing witness population: `474`
...
1. tranche-level generation rules for the remaining 474 rows,
