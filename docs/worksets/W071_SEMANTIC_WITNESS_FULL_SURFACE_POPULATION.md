...
3. `211` seeded witness rows,
4. a frozen remaining-surface gap inventory for `306` supported rows,
...
2. current witness-covered rows: `211`
3. current remaining supported rows needing witness population: `306`
...
1. tranche-level generation rules for the remaining 306 rows,
