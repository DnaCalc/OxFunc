...
2. current witness-covered rows: `16`
3. current remaining supported rows needing witness population: `501`
...
1. tranche-level generation rules for the remaining 501 rows,
