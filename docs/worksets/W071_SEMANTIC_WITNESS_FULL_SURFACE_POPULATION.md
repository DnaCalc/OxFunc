...
3. `67` seeded witness rows,
4. a frozen remaining-surface gap inventory for `450` supported rows,
...
2. current witness-covered rows: `67`
3. current remaining supported rows needing witness population: `450`
...
1. tranche-level generation rules for the remaining 450 rows,
