...
3. `121` seeded witness rows,
4. a frozen remaining-surface gap inventory for `396` supported rows,
...
2. current witness-covered rows: `121`
3. current remaining supported rows needing witness population: `396`
...
1. tranche-level generation rules for the remaining 396 rows,
