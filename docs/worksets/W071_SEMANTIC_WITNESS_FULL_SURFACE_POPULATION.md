...
3. `160` seeded witness rows,
4. a frozen remaining-surface gap inventory for `357` supported rows,
...
2. current witness-covered rows: `160`
3. current remaining supported rows needing witness population: `357`
...
1. tranche-level generation rules for the remaining 357 rows,
