...
3. `235` seeded witness rows,
4. a frozen remaining-surface gap inventory for `282` supported rows,
...
2. current witness-covered rows: `235`
3. current remaining supported rows needing witness population: `282`
...
1. tranche-level generation rules for the remaining 282 rows,
