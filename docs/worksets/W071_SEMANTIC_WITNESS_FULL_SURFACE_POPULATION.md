...
3. `232` seeded witness rows,
4. a frozen remaining-surface gap inventory for `285` supported rows,
...
2. current witness-covered rows: `232`
3. current remaining supported rows needing witness population: `285`
...
1. tranche-level generation rules for the remaining 285 rows,
