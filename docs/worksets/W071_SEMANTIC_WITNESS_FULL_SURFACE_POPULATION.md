...
3. `178` seeded witness rows,
4. a frozen remaining-surface gap inventory for `339` supported rows,
...
2. current witness-covered rows: `178`
3. current remaining supported rows needing witness population: `339`
...
1. tranche-level generation rules for the remaining 339 rows,
