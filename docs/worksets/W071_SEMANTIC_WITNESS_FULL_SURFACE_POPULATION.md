...
3. `184` seeded witness rows,
4. a frozen remaining-surface gap inventory for `333` supported rows,
...
2. current witness-covered rows: `184`
3. current remaining supported rows needing witness population: `333`
...
1. tranche-level generation rules for the remaining 333 rows,
