...
3. `61` seeded witness rows,
4. a frozen remaining-surface gap inventory for `456` supported rows,
...
2. current witness-covered rows: `61`
3. current remaining supported rows needing witness population: `456`
...
1. tranche-level generation rules for the remaining 456 rows,
