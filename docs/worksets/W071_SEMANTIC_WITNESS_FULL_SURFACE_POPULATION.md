...
3. `226` seeded witness rows,
4. a frozen remaining-surface gap inventory for `291` supported rows,
...
2. current witness-covered rows: `226`
3. current remaining supported rows needing witness population: `291`
...
1. tranche-level generation rules for the remaining 291 rows,
