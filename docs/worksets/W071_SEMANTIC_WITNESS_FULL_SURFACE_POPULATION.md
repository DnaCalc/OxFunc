...
3. `151` seeded witness rows,
4. a frozen remaining-surface gap inventory for `366` supported rows,
...
2. current witness-covered rows: `151`
3. current remaining supported rows needing witness population: `366`
...
1. tranche-level generation rules for the remaining 366 rows,
