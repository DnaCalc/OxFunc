...
3. `115` seeded witness rows,
4. a frozen remaining-surface gap inventory for `402` supported rows,
...
2. current witness-covered rows: `115`
3. current remaining supported rows needing witness population: `402`
