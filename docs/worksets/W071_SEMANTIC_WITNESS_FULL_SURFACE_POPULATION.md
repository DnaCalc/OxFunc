...
3. `259` seeded witness rows,
4. a frozen remaining-surface gap inventory for `258` supported rows,
...
2. current witness-covered rows: `259`
3. current remaining supported rows needing witness population: `258`
...
1. tranche-level generation rules for the remaining 258 rows,
