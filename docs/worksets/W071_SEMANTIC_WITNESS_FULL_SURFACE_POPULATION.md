...
3. `52` seeded witness rows,
4. a frozen remaining-surface gap inventory for `465` supported rows,
...
2. current witness-covered rows: `52`
3. current remaining supported rows needing witness population: `465`
...
1. tranche-level generation rules for the remaining 465 rows,
