...
3. `58` seeded witness rows,
4. a frozen remaining-surface gap inventory for `459` supported rows,
...
2. current witness-covered rows: `58`
3. current remaining supported rows needing witness population: `459`
...
1. tranche-level generation rules for the remaining 459 rows,
