...
3. `199` seeded witness rows,
4. a frozen remaining-surface gap inventory for `318` supported rows,
...
2. current witness-covered rows: `199`
3. current remaining supported rows needing witness population: `318`
...
1. tranche-level generation rules for the remaining 318 rows,
