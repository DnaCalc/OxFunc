...
3. `148` seeded witness rows,
4. a frozen remaining-surface gap inventory for `369` supported rows,
...
2. current witness-covered rows: `148`
3. current remaining supported rows needing witness population: `369`
...
1. tranche-level generation rules for the remaining 369 rows,
