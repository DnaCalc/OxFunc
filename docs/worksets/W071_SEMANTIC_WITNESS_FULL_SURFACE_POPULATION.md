...
3. `145` seeded witness rows,
4. a frozen remaining-surface gap inventory for `372` supported rows,
...
2. current witness-covered rows: `145`
3. current remaining supported rows needing witness population: `372`
...
1. tranche-level generation rules for the remaining 372 rows,
