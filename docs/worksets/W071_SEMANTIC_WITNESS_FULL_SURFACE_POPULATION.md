...
3. `190` seeded witness rows,
4. a frozen remaining-surface gap inventory for `327` supported rows,
...
2. current witness-covered rows: `190`
3. current remaining supported rows needing witness population: `327`
...
1. tranche-level generation rules for the remaining 327 rows,
