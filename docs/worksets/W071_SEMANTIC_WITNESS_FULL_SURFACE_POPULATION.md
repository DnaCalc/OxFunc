...
3. `187` seeded witness rows,
4. a frozen remaining-surface gap inventory for `330` supported rows,
...
2. current witness-covered rows: `187`
3. current remaining supported rows needing witness population: `330`
...
1. tranche-level generation rules for the remaining 330 rows,
