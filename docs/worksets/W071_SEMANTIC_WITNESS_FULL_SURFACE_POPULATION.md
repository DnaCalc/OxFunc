...
3. `40` seeded witness rows,
4. a frozen remaining-surface gap inventory for `477` supported rows,
...
2. current witness-covered rows: `40`
3. current remaining supported rows needing witness population: `477`
...
1. tranche-level generation rules for the remaining 477 rows,
