...
3. `124` seeded witness rows,
4. a frozen remaining-surface gap inventory for `393` supported rows,
...
2. current witness-covered rows: `124`
3. current remaining supported rows needing witness population: `393`
...
1. tranche-level generation rules for the remaining 393 rows,
