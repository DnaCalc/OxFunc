...
3. `142` seeded witness rows,
4. a frozen remaining-surface gap inventory for `375` supported rows,
...
2. current witness-covered rows: `142`
3. current remaining supported rows needing witness population: `375`
...
1. tranche-level generation rules for the remaining 375 rows,
