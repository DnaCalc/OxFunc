...
3. `100` seeded witness rows,
4. a frozen remaining-surface gap inventory for `417` supported rows,
...
2. current witness-covered rows: `100`
3. current remaining supported rows needing witness population: `417`
