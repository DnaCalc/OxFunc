...
3. `97` seeded witness rows,
4. a frozen remaining-surface gap inventory for `420` supported rows,
...
2. current witness-covered rows: `97`
3. current remaining supported rows needing witness population: `420`
