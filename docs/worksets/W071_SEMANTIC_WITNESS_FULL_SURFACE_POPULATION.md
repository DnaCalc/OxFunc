...
3. `31` seeded witness rows,
4. a frozen remaining-surface gap inventory for `486` supported rows,
...
2. current witness-covered rows: `31`
3. current remaining supported rows needing witness population: `486`
...
1. tranche-level generation rules for the remaining 486 rows,
