...
3. `118` seeded witness rows,
4. a frozen remaining-surface gap inventory for `399` supported rows,
...
2. current witness-covered rows: `118`
3. current remaining supported rows needing witness population: `399`
...
1. tranche-level generation rules for the remaining 399 rows,
