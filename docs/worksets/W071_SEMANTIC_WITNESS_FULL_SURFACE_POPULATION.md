...
3. `229` seeded witness rows,
4. a frozen remaining-surface gap inventory for `288` supported rows,
...
2. current witness-covered rows: `229`
3. current remaining supported rows needing witness population: `288`
...
1. tranche-level generation rules for the remaining 288 rows,
