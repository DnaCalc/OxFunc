...
3. `214` seeded witness rows,
4. a frozen remaining-surface gap inventory for `303` supported rows,
...
2. current witness-covered rows: `214`
3. current remaining supported rows needing witness population: `303`
...
1. tranche-level generation rules for the remaining 303 rows,
