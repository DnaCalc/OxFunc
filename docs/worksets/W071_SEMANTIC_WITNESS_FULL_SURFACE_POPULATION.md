...
3. `103` seeded witness rows,
4. a frozen remaining-surface gap inventory for `414` supported rows,
...
2. current witness-covered rows: `103`
3. current remaining supported rows needing witness population: `414`
