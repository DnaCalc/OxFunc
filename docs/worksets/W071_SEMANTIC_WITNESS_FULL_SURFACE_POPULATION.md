...
3. `64` seeded witness rows,
4. a frozen remaining-surface gap inventory for `453` supported rows,
...
2. current witness-covered rows: `64`
3. current remaining supported rows needing witness population: `453`
...
1. tranche-level generation rules for the remaining 453 rows,
