...
3. `157` seeded witness rows,
4. a frozen remaining-surface gap inventory for `360` supported rows,
...
2. current witness-covered rows: `157`
3. current remaining supported rows needing witness population: `360`
...
1. tranche-level generation rules for the remaining 360 rows,
