...
5. open_lanes:
   - landed-ref promotion for the local sort-family omission fix
   - bounded adjacent review for other dynamic-array reshape functions with
     optional defaulted controls
