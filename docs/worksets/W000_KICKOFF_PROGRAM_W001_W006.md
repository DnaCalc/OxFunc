...
3. deliver the first function-phase-complete slices (`PI()`, `ABS`, and `XMATCH`) under unified doctrine.
...
6. W6: `function-phase-complete` (XMATCH now has current-phase contract/formal/runtime/evidence closure, including expanded blank-vs-empty, binary duplicate, unsorted binary, and XLL bridge parity lanes under `W6-XMATCH-EXP-20260310`).
...
1. `W008_STRING_W8_1_CHECKLIST.md` (W8.1)
2. `W009_XLL_ADDIN_BRIDGE.md` (W9)
