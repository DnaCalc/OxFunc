...
private instance instDecidableEqExceptLcm [DecidableEq ε] [DecidableEq α] : DecidableEq (Except ε α)
  | .error a, .error b =>
...
theorem lcmMeta_profiles :
    lcmMeta.argPreparationProfile = ArgPreparationProfile.valuesOnlyPreAdapter
    ∧ lcmMeta.surfaceFecDependencyProfile = FecDependencyProfile.refOnly := by
  simp [lcmMeta]
